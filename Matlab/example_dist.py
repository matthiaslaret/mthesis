# coding: utf-8
get_ipython().magic('loadpy dist_agn.py')
# %load dist_agn.py
###### Import stuff ###### 
import numpy as np
...
def draw_flatlog_samples(**kwargs):
    ...
    return m1, m2
m1,m2 = draw_powerlaw_samples()
m1
m2
m1,m2 = draw_powerlaw_samples(nsamples=100)
m1
m2
a1, a2 = draw_flatlog_samples()
a1
a2
a1, a2 = draw_flatlog_samples(nsample=100,min_mass=0.1,max_mass=10e5) 
a1
a1, a2 = draw_flatlog_samples(nsample=100,min_mass=0.1,max_mass=10e5)
a1, a2 = draw_flatlog_samples(nsamples=100,min_mass=0.1,max_mass=10e5)
a1
a2
a1, a2 = draw_flatlog_samples(nsamples=100,min_mass=0.1,max_mass=10e5) 
