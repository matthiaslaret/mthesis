    ...
    for j=1:Iq
        ...
        for l=1:Ia
            ...
            for n=1:Ie
                [i,j,l,n]
                e0 = e(n);  
                mergertime = lifetime_res(Mbin,mu,qres,m1,sigma,a0,e0);
...
plot(mrgtimes,'o')
    ...
    function [lifetime]=lifetime_res(M,mu,q,m1,sigma,a0,e0)
        options = odeset('RelTol',1e-6,'Stats','on');
        [tv,Yv]=ode45(@(t,y) funsys_3(t,y,G,c,M,mu,q,m1,sigma),[0 1e20],[a0;e0],options);
        lifetime = tv(end)/31536000;
        plot(tv/31536000,Yv(:,1));
        plot(tv/31536000,Yv(:,2));
    end
