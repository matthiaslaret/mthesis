...
fg = 0.1; % total surface density divided by gas surface density
rb = G*Msmbh /sigma^2;
...
sigmar = sigma^2./(pi*r*G); %surface density at r 
csr = fg /(2^(3/2)) * sqrt(G*Msmbh/r) ; %sound speed at r 
...
%                 e0 = 0.001;
                ...
                mergertime = lifetime(x,dec,Mbin,mu,m1,q1,a0,e0,alpha,sigmar,csr);
